...
import style from "./ListShowsWide.module.css";
import Loading from "../../components/Loading";

function ListShowsWide(props) {
    ...
    <div className={style.listwrapper}>
      ...
      <div className={style.horizontalList} id={props.id}>
        {data?.map((e, i) => {
          ...
          return (
            <HorizontalCard image={imgurl} title={e.title || e.name} key={i} />
          );
        })}
      </div>
